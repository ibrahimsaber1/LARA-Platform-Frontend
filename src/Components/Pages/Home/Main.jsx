...
<main className=" ">
  <div className="container main">
    <div className="header-section d-flex justify-content-between align-items-center">
      ...
      <button className="btn create-assistant-btn">
    ...
    <div className="raw">
      <div className="search-filter-section d-flex align-items-center mb-4 col-lg-4">
        ...
        <button className="btn  filter-btn w-10">Type <i className="fa-sharp-duotone fa-solid fa-caret-down"></i>
        </button>
        <button className="btn sort-btn w-10">
          <svg width={22} height={18} viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M14 13H8" stroke="#232323" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </button>
      </div>
    </div>
